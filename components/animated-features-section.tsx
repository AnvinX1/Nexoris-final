        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
          <div className="md:col-span-2">
            <BentoCard
              ...
              subtitle="Deploy applications globally with our robust cloud infrastructure and automated scaling"
          ...
          <div className="md:col-span-2">
            <BentoCard
              ...
              subtitle="Advanced encryption, compliance certifications, and 24/7 security monitoring"
          ...
          <div className="md:col-span-3">
            <BentoCard
              ...
              value="Seamless"
              subtitle="CI/CD pipelines, API integrations, and microservices architecture for modern development"
